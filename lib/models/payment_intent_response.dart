...
PaymentIntentResponse paymentIntentResponseFromMap(String str) => PaymentIntentResponse.fromMap(json.decode(str));

String paymentIntentResponseToMap(PaymentIntentResponse data) => json.encode(data.toMap());
...
class PaymentIntentResponse {
    ...
    Map<String, dynamic> toMap() => {
        ...
        "payment_method_types": paymentMethodTypes != null ? List<dynamic>.from( paymentMethodTypes!.map((x) => x) ): paymentMethodTypes,
